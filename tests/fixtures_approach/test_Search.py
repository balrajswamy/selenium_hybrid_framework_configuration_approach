...
def test_search_for_valid_product(setup_and_teardown):
...
def test_search_for_invalid_product(setup_and_teardown):
...
def test_search_without_entering_any_product_input(setup_and_teardown):
